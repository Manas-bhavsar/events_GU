...
export default async function EventDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-[#0b0b0f] to-[#141824] relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto space-y-10">
            <header className="text-center space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                <span className="px-3 py-1 rounded-md bg-white/10 text-light text-sm border border-white/10">{new Date(event.date).toLocaleDateString()}</span>
                <span className="px-3 py-1 rounded-md bg-accent-orange/15 text-accent-orange text-sm border border-accent-orange/40">{event.category}</span>
              </div>
            </header>
            ...
            <section className="grid md:grid-cols-3 gap-6">
              ...
              <aside className="rounded-xl border border-white/10 bg-white/5 p-6 space-y-4">
                ...
                <div className="pt-2 flex gap-3" style={{ pointerEvents: 'auto' }}>
                  <a href="#" className="event-btn event-btn-primary">Register</a>
                  <a href="#" className="event-btn event-btn-secondary">Contact</a>
                </div>
              </aside>
            </section>
          </div>
